...
local warning_title = "Weather Widget"
local parameter_warning = "Required parameters are not set: "
local directions = {"N", "NNE", "NE", "ENE", "E", "ESE", "SE", "SSE", "S", "SSW", "SW", "WSW", "W", "WNW", "NW", "NNW", "N"}
local feels_like = "Feels like "
local wind = "Wind: "
local humidity = "Humidity: "
local uv = "UV: "
...
local function worker(user_args)
    ...
    if args.coordinates == nil or args.api_key == nil then
        show_warning(parameter_warning ..
    ...
    local current_weather_widget = wibox.widget {
        ...
        update = function(self, weather)
            ...
            self:get_children_by_id('feels_like_temp')[1]:set_text(
                feels_like .. gen_temperature_str(weather.feels_like, '%.0f', false, units))
